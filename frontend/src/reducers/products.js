...
function productList(state = { products: [] }, action) {
...
function productDetails(state = { product: {} }, action) {
...
function productDelete(state = { product: {} }, action) {
...
function productSave(state = { product: {} }, action) {
...
export { productList, productDetails, productSave, productDelete }